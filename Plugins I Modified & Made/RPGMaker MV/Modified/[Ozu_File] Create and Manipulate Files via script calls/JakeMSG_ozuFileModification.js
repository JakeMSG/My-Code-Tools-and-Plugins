//=============================================================================
//  JakeMSG_ozuFileModification.js v1.2
//=============================================================================

/*:
 * @author ozubon+JakeMSG
 ...
 * file.Dwrite
 * ===========================================================================
 * Works similarly to the "file.write" function, but can also automatically create a new folder when specifying the "path" parameter (if the folder specified in "path" does not exist yet)
 * However, in this way, it can only create 1 new folder per script call (you cannot create 2 nested New Folders at once!)
 * This can easily be solved by repeatedly calling this function, each time creating 1 new level of the nested New folder.
 * = eg:
 * firstpath = "<PathWithExistentFolders>/<FirstNewFolderName>"
 * secondpath = "<PathWithExistentFolders>/<FirstNewFolderName>/<SecondNewFolderName>"
 *
 */
...
(function() {
    function setup() {
        ...
        file.Dwrite = function(filePath, filename, data) {
            filePath = this.createPath(filePath);
